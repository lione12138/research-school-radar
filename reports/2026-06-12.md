...
- GFZ Potsdam: HTTPSConnectionPool(host='www.gfz-potsdam.de', port=443): Max retries exceeded with url: /en/events (Caused by ConnectTimeoutError(<HTTPSConnection(host='www.gfz-potsdam.de', port=443) at 0x7ff5822500e0>, 'Connection to www.gfz-potsdam.de timed out. (connect timeout=20)'))
